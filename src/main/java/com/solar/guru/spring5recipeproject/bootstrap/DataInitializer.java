...
public class DataInitializer implements CommandLineRunner {
    ...
    private List<Recipe> initData() {
        ...
        Ingredient egg = new Ingredient("egg", new BigDecimal(2), scrambledEggs, item);
        Ingredient butter = new Ingredient("butter", new BigDecimal(1), scrambledEggs, tablespoon);
        scrambledEggs.getIngredients().add(egg);
        scrambledEggs.getIngredients().add(butter);
        scrambledEggs.setDifficulty(Difficulty.EASY);
        scrambledEggs.setDirections("throw butter on the pan\nthen add eggs and mix it.");
        Note n = new Note();
        n.setRecipe(scrambledEggs);
        ...
        cake.setCookTime(23);
        Ingredient flavour = new Ingredient("flavour", new BigDecimal(22), cake, tablespoon);
        cake.getIngredients().add(egg);
        cake.getIngredients().add(flavour);
